...
2017年12月15日11:38:20  
当然,如果要连阿里云的话,上面的操作都没啥用.....  
连阿里云要烧AT透传固件...  

AT透传固件,第一次烧先烧All版本的:EMW3165_0000.0000.A201_all.bin  
然后使用JFlash烧录  
	JFlash 工程文件是 /home/senrsl/test/iot/MicoKit3165/Fog_v2_MiCOKIT_ENJOY/JFlash/mk3165v600.jflash  
	JFlash 工程配置图片是 /home/senrsl/test/iot/MicoKit3165/Fog_v2_MiCOKIT_ENJOY/JFlash/2017-12-15 14:06:54屏幕截图.png  
这个时候,一定要注意,JLink驱动,一定不要安最新的,要安JLink 6.0.0i<Setup_JLink_V600i.exe>这个版本,后面版本Target没有Auto,F7会烧录不成功....  

然后弹出框,地址 allbin 填是8000000,otabin是 800c000  

他们提供了一个评分1.0的视频合集: t.elecfans.com/3770.html  
...
3165的AT固件,只支持本地AT指令,不支持阿里云或他们自己的云....  
如果要接阿里云,只能根据Demo进行二次开发,据他们说,也不是太复杂....  
Demo的的地址是code.aliyun.com/MXCHIP_FAE/alink.git  
上面这个地址,打不开吧....  
打不开就对了,如果要进行二次开发,需要跟他们签署保密协议....  
然后后台是阿里小智的一个弱智,申请需要用企业支付宝,进行申请....  

一个月半月前,看到阿里云论坛上一小时调通买的....  

<font color="red" size=1000>屮</font>  
