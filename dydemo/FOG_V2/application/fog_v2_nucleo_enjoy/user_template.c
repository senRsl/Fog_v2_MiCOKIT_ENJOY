...
PLATFORM_APP_TEMPLATE_G paltform_app_template[] =
{
    ...
    {
        .type           =   USER_NODE_TYPE_ACC_ANG,
        .pid            =   USER_NODE_PID_ACC_X,
        .min            =   0,
        .max            =   0,
        .uint           =   "",
        .name           =   "加速度-X轴",
