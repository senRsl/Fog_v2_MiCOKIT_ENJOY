...
static mico_worker_thread_t sensor_worker_thread;
static mico_timed_event_t sensor_timed_event;
...
static OSStatus _sensor_read_handler( void* arg );
static OSStatus display_refresh( void* arg );
...
//    OLED_ShowString( 0, 6, mico_context->micoStatus.mac );
#endif
...
//    mico_rtos_create_worker_thread( &sensor_worker_thread, MICO_APPLICATION_PRIORITY, 2048, 1 );
//    mico_rtos_register_timed_event( &sensor_timed_event, &sensor_worker_thread, _sensor_read_handler, 2000, NULL );
}
...
void user_key1_clicked_callback( void )
{
    ...
    mico_rtos_send_asynchronous_event( &sensor_worker_thread, display_refresh, NULL );
}
